...
if __name__ == "__main__":
    ...
    from _new25.v260614_He_2d_Gauss.v260626b_He2dLnR_LcrSymm_run import He2dLnR_LcrSymm_run
    He2dLnR_LcrSymm_run().test_1()
