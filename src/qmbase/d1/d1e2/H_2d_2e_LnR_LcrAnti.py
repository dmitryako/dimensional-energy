...
log = Log.getLog('H_2d_2e_LnR_LcrAnti')


# todo: old, make (H1d2e_LgrrLcr) to make sure not using anthing from H1d2e_LgrrLcrSym
class H_2d_2e_LnR_LcrAnti(H2d2e_LcrAnti):  # H2d2e_LcrAnti(H1d2e_LgrrLcrAnti)
    ...
    def init_all(self):
        ...
        V2e_grid = np.maximum(rr1, rr2)
        dbg(V2e_grid)
        V2e_grid = np.maximum(V2e_grid, eps)    # before calling log(r12)
        dbg(V2e_grid)
        V2e_grid = W2d * (-2) * np.log(V2e_grid / cfg.r0)  # Vee,2d = -2 log(r12)
...
if __name__ == "__main__":
    ...
    from _new25.v260614_He_2d_Gauss.v260626a_He2dLnR_LcrAnti_run import He2dLnR_LcrAnti_run
    He2dLnR_LcrAnti_run().test_1()
