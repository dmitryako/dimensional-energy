...
class He1d_LgrrLcrSym_Test(FlowTest):
    ...
    def test_1(self):
        ...
        # load_mats rows: 100%|██████████| 2025/2025 [03:29<00:00,  9.68it/s]
        # wLcr1: nr1=1201, xmin=-5.0, xmax=5.298351055715546, rmin0.0, rmax=200.00000000000009
        # SYM h2x1e.engs(orth1N=45) = [-4.       -2.5      -2.222222 -2.125    -2.08    ]
        # SYM eng_2x1d1e=-4.0
        # err_eng_2x1e =  1.758593271006248e-13
        # SYM h2e_engs(orth1N=45) = [-2.107574 -2.050074 -2.028873 -2.018764 -2.013041]
        # eng_1d1e_n1(Z=2.0) = -2.0
        # SYM Delta(h2e_engs - eng_1d1e_n1) = [-0.107574 -0.050074 -0.028873 -0.018764 -0.013041]
        ...
        # # orth_err= 2.9976021664879227e-14
        # # wLcr1: nr1=1201, xmin=-5.0, xmax=5.298351055715546, rmin0.0, rmax=200.00000000000009
        # # SYM h2x1e.engs(orth1N=40) = [-4.       -2.5      -2.222222 -2.125    -2.08    ]
        # # SYM eng_2x1d1e=-4.0
        # # err_eng_2x1e =  1.1146639167236572e-13
        # # SYM h2e_engs(orth1N=40) = [-2.107514 -2.050052 -2.028863 -2.018752 -2.012674]
        # # eng_1d1e_n1(Z=2.0) = -2.0
        # # SYM Delta(h2e_engs - eng_1d1e_n1) = [-0.107514 -0.050052 -0.028863 -0.018752 -0.012674]
        # # cfg.eng_2e_check= -2.10839
        ...
        # # wLcr1: nr1=1201, xmin=-5.0, xmax=5.298351055715546, rmin0.0, rmax=200.00000000000009
        # # SYM h2x1e.engs(orth1N=35) = [-4.       -2.5      -2.222222 -2.125    -2.08    ]
        # # SYM eng_2x1d1e=-4.0
        # # err_eng_2x1e =  1.0702549957386509e-13
        # # SYM h2e_engs(orth1N=35) = [-2.107441 -2.050025 -2.028851 -2.018687 -2.011567]
        # # eng_1d1e_n1(Z=2.0) = -2.0
        # # SYM Delta(h2e_engs - eng_1d1e_n1) = [-0.107441 -0.050025 -0.028851 -0.018687 -0.011567]

        orth1N = 25;  cfg.max_err_2x1e = 1e-5;  cfg.max_err_2e = 0.002
        basis_lambda_ = 1.0 * cfg.atom_z
        nr1 = 1201; r1_max = 200.; r1_min = 0.0;  x1_min = -5.
        # orth_err= 1.1102230246251565e-14
        # wLcr1: nr1=1201, xmin=-5.0, xmax=5.298351055715546, rmin0.0, rmax=200.00000000000009
        # SYM h2x1e.engs(orth1N={cfg.orth1N}) = [-4.       -2.5      -2.222222 -2.125    -2.08    ]
        # SYM eng_2x1d1e=-4.0
        # err_eng_2x1e =  1.2212453270876722e-13
        # SYM h2e_engs(orth1N=25) = [-2.107224 -2.049945 -2.028767 -2.016594 -2.001548]
        # eng_1d1e_n1(Z=2.0) = -2.0
        # SYM Delta(h2e_engs - eng_1d1e_n1) = [-0.107224 -0.049945 -0.028767 -0.016594 -0.001548]
        # cfg.eng_2e_check= -2.10839
        # AssertionError: quick check: eng_err=0.0011658105356127102, max_err=0.001
