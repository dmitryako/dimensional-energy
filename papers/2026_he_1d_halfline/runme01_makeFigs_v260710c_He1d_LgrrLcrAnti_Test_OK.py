...
class He1d_LgrrLcrAnti_Test(FlowTest):
    ...
    def test_1(self):
        ...
        # h2x1e.getEigEngs = [-2.5      -2.222222 -2.124913 -2.073717 -2.015039]
        # h2x1e_anti.engs [-2.5      -2.222222 -2.124913 -2.073717 -2.015039]
        # err_eng_2x1e =  1.0702549957386509e-13
        # h2e.getEigEngs = [-2.108386 -2.049401 -2.011781 -1.956684 -1.88015 ]
        # rerun:
        # h2x1e.getEigEngs = [-2.5      -2.222222 -2.124913 -2.073717 -2.015039]
        # h2x1e_anti.engs [-2.5      -2.222222 -2.124913 -2.073717 -2.015039]
        # err_eng_2x1e =  1.0702549957386509e-13
        ...
        cfg.plot_on = True;  cfg.fig_dpis = [300]
        cfg.plot_evec_idx = 0  # 0 is ground
        # h2x1e.getEigEngs = [-2.5      -2.222221 -2.123399 -2.05158  -1.947688]
        # h2x1e_anti.engs [-2.5      -2.222221 -2.123399 -2.05158  -1.947688]
        # err_eng_2x1e =  1.1191048088221578e-13
        # h2e.getEigEngs = [-2.108372 -2.045252 -1.984984 -1.892632 -1.763253]
...
if __name__ == "__main__":
    ...
    # He1d_LgrrOrthLcr_Test().testSmallHeBasis()
    # He1d_LgrrOrthLcr_Test().testSingleZeta()
    # He1d_LgrrOrthLcr_Test().testBasisNc()
