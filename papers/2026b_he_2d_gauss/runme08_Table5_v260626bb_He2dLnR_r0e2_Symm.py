...
log = Log.getLog('He2dLnR_r0e2_LcrSymm_run')
...
class He2dLnR_r0e2_LcrSymm_run(FlowTest):
    ...
    def test_1(self):
        ...
        # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5547825, -2.0169567, 0.0608853, 1.4506670
        # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8531939, -1.9883631, -0.9428755, -0.2602532
        # err_eng =  0.005733418373188748

        lambda_ = 4; orth1N = 10; nx1 = 1201; x1_min = -12.
        # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5604642, -2.0215050, 0.0422112, 1.3954025
        # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8571090, -1.9908799, -0.9457647, -0.2646692
        # err_eng =  5.1698729346405514e-05
        # RERUN:
        # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5604642, -2.0215050, 0.0422112, 1.3954025
        # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8571090, -1.9908799, -0.9457647, -0.2646692
        # err_eng =  5.1698729346405514e-05
        ...
        # # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5605126, -2.0215443, 0.0421794, 1.3952405
        # # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8571894, -1.9909247, -0.9458061, -0.2647272
        # # err_eng =  3.329245367389433e-06
        #
        # lambda_ = 4; orth1N = 30; nx1 = 1201; x1_min = -12.
        # # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5605159, -2.0215465, 0.0421775, 1.3952387
        # # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8571959, -1.9909279, -0.9458088, -0.2647296
        # # err_eng =  -2.4074883420155402e-08
        #
        # lambda_ = 4; orth1N = 35; nx1 = 1201; x1_min = -12.
        # # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5605163, -2.0215467, 0.0421772, 1.3952384
        # # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8571968, -1.9909283, -0.9458091, -0.2647299
        # # err_eng =  -4.128283448423531e-07
        #
        # lambda_ = 4; orth1N = 35; nx1 = 2001; x1_min = -12.
        # # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5605163, -2.0215467, 0.0421772, 1.3952384
        # # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8572098, -1.9909315, -0.9458112, -0.2647314
        # # err_eng =  -4.12910035052505e-07
        #
        # lambda_ = 4; orth1N = 40; nx1 = 2001; x1_min = -12.
        # # H_2d_2e_LnR_LcrSymm: h2x1e_symm.getEigEngs= -6.5605165, -2.0215468, 0.0421771, 1.3952383
        # # H_2d_2e_LnR_LcrSymm: h2e_symm.getEigEngs= -4.8572103, -1.9909317, -0.9458113, -0.2647316
        # # err_eng =  -6.025672316667396e-07
        ...
        Log.getLog('H_2d_2e_LnR_LcrSymm').setDbg(DBG_ON)  #
        # Log.getLog('H_2d_2e_LnR_LcrSymm').setDbg(False)  # H_2d_2e_LnR_LcrAnti

        Log.print_dbg_logs()
        from d1.d1e2.H_2d_2e_LnR_LcrSymm import H_2d_2e_LnR_LcrSymm
        H_2d_2e_LnR_LcrSymm(cfg).diag_on_2orth1(sign=-1)
    #     - WFQuadrLcr: dbg True
...
if __name__ == "__main__":
    He2dLnR_r0e2_LcrSymm_run().test_1()
